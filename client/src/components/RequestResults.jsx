                ...
                <div className="overflow-y-scroll h-full no-scrollbar">
                    ...
                    {requestResponse[0].map((option, index) => (
                        ...
                        {option.route.status === 200 && (
                            ...
                            ticket_share={option.pricing.ticket_share} alternative_share={option.pricing.alternative_share} safety_share={option.pricing.safety_share} total_ticket={option.pricing.total_ticket_prices}
