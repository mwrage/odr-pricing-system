...
function TripOptionCard(props) {
    ...
    const segments = [
        ...
        { factor:"Ticket", label: ticket_share, value: ticket_share < 0 ? ticket_share * (-1) : ticket_share, color: ticket_share < 0 ? "rgba(245, 158, 11, 0.2)" : "#f59e0b", textColorDonut: "#f59e0b", textColorBar: ticket_share < 0 ? "text-zinc-800" : "text-white" },        
        { factor:"Alternativangebot", label: alternative_share, value: alternative_share < 0 ? alternative_share * (-1) : alternative_share, color: alternative_share < 0 ? "rgba(236, 72, 153, 0.2)" : "#ec4899", textColorDonut: "#ec4899", textColorBar: alternative_share < 0 ? "text-zinc-800" : "text-white"},
        { factor:"Sicherheit", label: safety_share, value: safety_share < 0 ? safety_share * (-1) : safety_share, color: safety_share < 0 ? "rgba(99, 102, 241, 0.2)" : "#6366f1", textColorDonut: "#6366f1", textColorBar: safety_share < 0 ? "text-zinc-800" : "text-white"},
        { factor:"Komfort", label: comfort_share, value: comfort_share < 0 ? comfort_share * (-1) : comfort_share, color: comfort_share < 0 ? "rgba(14, 165, 233, 0.2)" : "#0ea5e9", textColorDonut: "#0ea5e9", textColorBar: comfort_share < 0 ? "text-zinc-800" : "text-white"},  
    ];
